...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<?> handleIllegalState(IllegalStateException ex, HttpServletRequest request) {
        // Conflicts: duplicate enrollment, already on waitlist, etc.
    ...
    public ResponseEntity<?> handleDataIntegrity(DataIntegrityViolationException ex, HttpServletRequest request) {
        ...
        String rootMsg = (cause != null && cause.getMessage() != null) ? cause.getMessage() : ex.getMessage();
    ...
    public ResponseEntity<?> handleMaxUploadSize(MaxUploadSizeExceededException ex, HttpServletRequest request) {
        ...
        return ResponseEntity.status(HttpStatus.BAD_REQUEST)
                .body(baseBody(HttpStatus.BAD_REQUEST, "Fichier trop volumineux (max 5 Mo).", request));
    }
